...
\centering
\includegraphics[width=0.70\linewidth]{fig03_fit_CB_PB.png}
\vspace{-0.3em}
{\footnotesize\textbf{Fig.\,3.} OLS fitted curve with 95\% asymptotic confidence band (dark) and prediction band (light).}
